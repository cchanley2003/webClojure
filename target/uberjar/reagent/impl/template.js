...
var G__13068 = o;
(G__13068[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
while (G__13070__i < G__13070__a.length) {G__13070__a[G__13070__i] = arguments[G__13070__i + 0]; ++G__13070__i;}
  args = new cljs.core.IndexedSeq(G__13070__a,0);
} 
...
var old_13072 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_13072))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_13072)].join(''):class$));
} else {
}
...
var G__13075 = jsprops;
(G__13075["defaultValue"] = value);

(G__13075["onChange"] = ((function (G__13075,v,value,on_change){
return (function (p1__13073_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13073_SHARP_);
});})(G__13075,v,value,on_change))
);
...
var vec__13077 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13077,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13077,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13077,(2),null);
...
var temp__4659__auto__ = (function (){var G__13081 = cljs.core.meta(v);
if((G__13081 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__13081);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__13083_13084 = v;
var G__13083_13085__$1 = (((G__13083_13084 == null))?null:reagent.impl.template.key_from_vec(G__13083_13084));
if((G__13083_13085__$1 == null)){
} else {
(jsprops["key"] = G__13083_13085__$1);
}
...
var G__13089 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13089) : reagent.impl.template.as_element.call(null,G__13089));
} else {
var p = (function (){var temp__4659__auto__ = (function (){var G__13090 = cljs.core.meta(argv);
if((G__13090 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__13090);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__13091 = (((jsprops == null))?{}:jsprops);
(G__13091["key"] = key);
...
var G__13092 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13092;
continue;
}
} else {
...
var n__7122__auto___13093 = a.length;
var i_13094 = (0);
while(true){
if((i_13094 < n__7122__auto___13093)){
(a[i_13094] = reagent.impl.template.as_element((a[i_13094])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7122__auto___13096 = a.length;
var i_13097 = (0);
while(true){
if((i_13097 < n__7122__auto___13096)){
var val_13098 = (a[i_13097]);
if((cljs.core.vector_QMARK_(val_13098)) && ((reagent.impl.template.key_from_vec(val_13098) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13097] = reagent.impl.template.as_element(val_13098));
...
var G__13101 = (cljs.core.count(argv) - first_child);
switch (G__13101) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13101){
