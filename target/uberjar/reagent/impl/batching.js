...
var c_16320 = (a[i]);
if(cljs.core.truth_((c_16320["cljsIsDirty"]))){
(c_16320["forceUpdate"])();
} else {
}
...
var G__16323 = ((function (this$){
return (function (){
return this$.run_queue();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__16323) : reagent.impl.batching.next_tick.call(null,G__16323));
}
});
...
var G__16325 = c;
var G__16325__$1 = (((G__16325 == null))?null:(G__16325["props"]));
if((G__16325__$1 == null)){
return null;
} else {
return (G__16325__$1["argv"]);
}
});
...
var G__16327_16328 = (c["cljsRatom"]);
if((G__16327_16328 == null)){
} else {
reagent.ratom.dispose_BANG_(G__16327_16328);
}
