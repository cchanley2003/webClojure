...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__22845__auto__,writer__22846__auto__,opt__22847__auto__){
return cljs.core._write.call(null,writer__22846__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__22239__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__22239__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__22239__auto__)){
return or__22239__auto__;
} else {
...
var G__24450 = o;
(G__24450[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_24454 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_24454))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_24454)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__22227__auto__ = (node === document.activeElement);
if(and__22227__auto__){
var and__22227__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__22227__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__24457 = jsprops;
(G__24457["defaultValue"] = value);

(G__24457["onChange"] = ((function (G__24457,v,value,on_change){
return (function (p1__24455_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24455_SHARP_);
});})(G__24457,v,value,on_change))
);
...
var vec__24459 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24459,(0),null);
var id = cljs.core.nth.call(null,vec__24459,(1),null);
var class$ = cljs.core.nth.call(null,vec__24459,(2),null);
...
var temp__4659__auto__ = (function (){var G__24463 = cljs.core.meta.call(null,v);
if((G__24463 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__24463);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__24465_24466 = v;
var G__24465_24467__$1 = (((G__24465_24466 == null))?null:reagent.impl.template.key_from_vec.call(null,G__24465_24466));
if((G__24465_24467__$1 == null)){
} else {
(jsprops["key"] = G__24465_24467__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__24470 = cljs.core.meta.call(null,argv);
if((G__24470 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__24470);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var n__23154__auto___24473 = a.length;
var i_24474 = (0);
while(true){
if((i_24474 < n__23154__auto___24473)){
...
var a = cljs.core.into_array.call(null,s);
var n__23154__auto___24476 = a.length;
var i_24477 = (0);
while(true){
if((i_24477 < n__23154__auto___24476)){
...
if(cljs.core.truth_((function (){var and__22227__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__22227__auto__){
return (ctx["no-key"]);
} else {
return and__22227__auto__;
