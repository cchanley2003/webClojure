...
var or__21651__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__21651__auto__)){
return or__21651__auto__;
} else {
var or__21651__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__21651__auto____$1)){
return or__21651__auto____$1;
} else {
var or__21651__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__21651__auto____$2)){
return or__21651__auto____$2;
} else {
var or__21651__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__21651__auto____$3)){
return or__21651__auto____$3;
} else {
...
var n__22566__auto__ = a.length;
var i = (0);
while(true){
if((i < n__22566__auto__)){
var c_23201 = (a[i]);
if(cljs.core.truth_((c_23201["cljsIsDirty"]))){
(c_23201["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__22257__auto__,writer__22258__auto__,opt__22259__auto__){
return cljs.core._write.call(null,writer__22258__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__23205 = c;
var G__23205__$1 = (((G__23205 == null))?null:(G__23205["props"]));
if((G__23205__$1 == null)){
return null;
} else {
return (G__23205__$1["argv"]);
}
});
...
var G__23207_23208 = (c["cljsRatom"]);
if((G__23207_23208 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__23207_23208);
}
