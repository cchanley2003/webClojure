...
var or__21788__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__21788__auto__)){
return or__21788__auto__;
} else {
var or__21788__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__21788__auto____$1)){
return or__21788__auto____$1;
} else {
var or__21788__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__21788__auto____$2)){
return or__21788__auto____$2;
} else {
var or__21788__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__21788__auto____$3)){
return or__21788__auto____$3;
} else {
...
var n__22703__auto__ = a.length;
var i = (0);
while(true){
if((i < n__22703__auto__)){
var c_23717 = (a[i]);
if(cljs.core.truth_((c_23717["cljsIsDirty"]))){
(c_23717["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__22394__auto__,writer__22395__auto__,opt__22396__auto__){
return cljs.core._write.call(null,writer__22395__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__23721 = c;
var G__23721__$1 = (((G__23721 == null))?null:(G__23721["props"]));
if((G__23721__$1 == null)){
return null;
} else {
return (G__23721__$1["argv"]);
}
});
...
var G__23723_23724 = (c["cljsRatom"]);
if((G__23723_23724 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__23723_23724);
}
