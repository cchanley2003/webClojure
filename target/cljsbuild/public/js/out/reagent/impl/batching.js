...
var or__22239__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__22239__auto__)){
return or__22239__auto__;
} else {
var or__22239__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__22239__auto____$1)){
return or__22239__auto____$1;
} else {
var or__22239__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__22239__auto____$2)){
return or__22239__auto____$2;
} else {
var or__22239__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__22239__auto____$3)){
return or__22239__auto____$3;
} else {
...
var n__23154__auto__ = a.length;
var i = (0);
while(true){
if((i < n__23154__auto__)){
var c_24386 = (a[i]);
if(cljs.core.truth_((c_24386["cljsIsDirty"]))){
(c_24386["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__22845__auto__,writer__22846__auto__,opt__22847__auto__){
return cljs.core._write.call(null,writer__22846__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__24390 = c;
var G__24390__$1 = (((G__24390 == null))?null:(G__24390["props"]));
if((G__24390__$1 == null)){
return null;
} else {
return (G__24390__$1["argv"]);
}
});
...
var G__24392_24393 = (c["cljsRatom"]);
if((G__24392_24393 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__24392_24393);
}
