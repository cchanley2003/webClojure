...
cljs.core.async.impl.dispatch.run.call(null,((function (c__24908__auto__,navigation){
return (function (){
var f__24909__auto__ = (function (){var switch__24796__auto__ = ((function (c__24908__auto__,navigation){
return (function (state_27724){
var state_val_27725 = (state_27724[(1)]);
if((state_val_27725 === (1))){
var state_27724__$1 = state_27724;
var statearr_27726_27740 = state_27724__$1;
(statearr_27726_27740[(2)] = null);

(statearr_27726_27740[(1)] = (2));
...
var state_27724__$1 = state_27724;
var statearr_27727_27741 = state_27724__$1;
(statearr_27727_27741[(1)] = (4));
...
var state_27724__$1 = state_27724;
return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_27724__$1,(7),navigation);
} else {
if((state_val_27725 === (5))){
var state_27724__$1 = state_27724;
var statearr_27729_27742 = state_27724__$1;
(statearr_27729_27742[(2)] = null);

(statearr_27729_27742[(1)] = (6));
...
var state_27724__$1 = state_27724;
var statearr_27730_27743 = state_27724__$1;
(statearr_27730_27743[(2)] = inst_27720);

(statearr_27730_27743[(1)] = (3));
...
var inst_27715 = inst_27714.token;
var inst_27716 = nav_handler.call(null,inst_27715);
var state_27724__$1 = (function (){var statearr_27731 = state_27724;
(statearr_27731[(7)] = inst_27716);

return statearr_27731;
})();
var statearr_27732_27744 = state_27724__$1;
(statearr_27732_27744[(2)] = null);

(statearr_27732_27744[(1)] = (2));
...
});})(c__24908__auto__,navigation))
;
return ((function (switch__24796__auto__,c__24908__auto__,navigation){
return (function() {
var accountant$core$dispatch_on_navigate_$_state_machine__24797__auto__ = null;
var accountant$core$dispatch_on_navigate_$_state_machine__24797__auto____0 = (function (){
var statearr_27736 = [null,null,null,null,null,null,null,null];
(statearr_27736[(0)] = accountant$core$dispatch_on_navigate_$_state_machine__24797__auto__);

(statearr_27736[(1)] = (1));

return statearr_27736;
});
var accountant$core$dispatch_on_navigate_$_state_machine__24797__auto____1 = (function (state_27724){
while(true){
var ret_value__24798__auto__ = (function (){try{while(true){
var result__24799__auto__ = switch__24796__auto__.call(null,state_27724);
...
var ex__24800__auto__ = e27737;
var statearr_27738_27745 = state_27724;
(statearr_27738_27745[(5)] = ex__24800__auto__);
...
var G__27746 = state_27724;
state_27724 = G__27746;
continue;
} else {
...
accountant$core$dispatch_on_navigate_$_state_machine__24797__auto__ = function(state_27724){
switch(arguments.length){
case 0:
return accountant$core$dispatch_on_navigate_$_state_machine__24797__auto____0.call(this);
case 1:
return accountant$core$dispatch_on_navigate_$_state_machine__24797__auto____1.call(this,state_27724);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
accountant$core$dispatch_on_navigate_$_state_machine__24797__auto__.cljs$core$IFn$_invoke$arity$0 = accountant$core$dispatch_on_navigate_$_state_machine__24797__auto____0;
accountant$core$dispatch_on_navigate_$_state_machine__24797__auto__.cljs$core$IFn$_invoke$arity$1 = accountant$core$dispatch_on_navigate_$_state_machine__24797__auto____1;
return accountant$core$dispatch_on_navigate_$_state_machine__24797__auto__;
})()
;})(switch__24796__auto__,c__24908__auto__,navigation))
})();
var state__24910__auto__ = (function (){var statearr_27739 = f__24909__auto__.call(null);
(statearr_27739[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__24908__auto__);
...
js_history.pushState(null,(function (){var or__21788__auto__ = title;
if(cljs.core.truth_(or__21788__auto__)){
return or__21788__auto__;
} else {
var or__21788__auto____$1 = document.title;
...
var any_key = (function (){var or__21788__auto__ = meta_key;
if(cljs.core.truth_(or__21788__auto__)){
return or__21788__auto__;
} else {
var or__21788__auto____$1 = alt_key;
if(cljs.core.truth_(or__21788__auto____$1)){
return or__21788__auto____$1;
} else {
var or__21788__auto____$2 = ctrl_key;
if(cljs.core.truth_(or__21788__auto____$2)){
return or__21788__auto____$2;
} else {
return shift_key;
}
}
...
if(cljs.core.truth_((function (){var and__21776__auto__ = cljs.core.not.call(null,any_key);
if(and__21776__auto__){
var and__21776__auto____$1 = cljs.core._EQ_.call(null,button,(0));
if(and__21776__auto____$1){
var and__21776__auto____$2 = path_exists_QMARK_.call(null,path);
if(cljs.core.truth_(and__21776__auto____$2)){
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__27748){
var map__27751 = p__27748;
...
var nav_handler = cljs.core.get.call(null,map__27751__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.call(null,map__27751__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
...
var params = cljs.core.map.call(null,(function (p1__27753_SHARP_){
return cljs.core.name.call(null,p1__27753_SHARP_);
...
return clojure.string.join.call(null,"=",p1__27754_SHARP_);
});})(params,values,pairs))
,pairs));
});
/**
...
var args27755 = [];
var len__22859__auto___27758 = arguments.length;
var i__22860__auto___27759 = (0);
while(true){
if((i__22860__auto___27759 < len__22859__auto___27758)){
args27755.push((arguments[i__22860__auto___27759]));

var G__27760 = (i__22860__auto___27759 + (1));
i__22860__auto___27759 = G__27760;
continue;
} else {
}
break;
